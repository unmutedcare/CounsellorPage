...
const Landing: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-b from-green-200 via-green-100 to-yellow-100">
      <div className="flex flex-col items-center justify-center h-full text-center animate-in fade-in duration-700">
        ...
        <h1 className="text-5xl font-extrabold text-[#3E5C35] mb-2 tracking-tight">
          Unmuted
        </h1>

        <p className="text-lg text-[#5B8C5A] mb-12 font-medium">
          Find your voice. Find your peace.
        </p>
